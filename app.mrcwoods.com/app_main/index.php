...
$navMap = [
    ...
    'tc' => ['page' => '../tc/', 'name' => '图床'],
    'aidraw' => ['page' => '../app_aidraw/', 'name' => 'AI绘画'],
    ...
    <script>
        ...
        window.addEventListener('message', (event) => {
            ...
            if (event.data?.type === 'OPEN_EXTERNAL_LINK') {
                console.log('Middle layer forwarding:', event.data);
